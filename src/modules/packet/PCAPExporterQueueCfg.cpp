...
#include "PCAPExporterQueueCfg.h"
...
PCAPExporterQueueCfg::PCAPExporterQueueCfg(XMLElement* elem)
	: CfgHelper<PCAPExporterQueue, PCAPExporterQueueCfg>(elem, "pcapExporterQueue"),
...
PCAPExporterQueueCfg* PCAPExporterQueueCfg::create(XMLElement* elem)
{
	assert(elem);
	assert(elem->getName() == getName());
	return new PCAPExporterQueueCfg(elem);
}

PCAPExporterQueueCfg::~PCAPExporterQueueCfg()
{
}
...
bool PCAPExporterQueueCfg::deriveFrom(PCAPExporterQueueCfg* old)
{
