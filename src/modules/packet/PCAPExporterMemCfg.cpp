...
PCAPExporterMemCfg* PCAPExporterMemCfg::create(XMLElement* elem)
{
	assert(elem);
	assert(elem->getName() == getName());
	return new PCAPExporterMemCfg(elem);
}

PCAPExporterMemCfg::~PCAPExporterMemCfg()
{
}
...
bool PCAPExporterMemCfg::deriveFrom(PCAPExporterMemCfg* old)
{
