...
{
public:
	time_t expireTime; /**<timestamp when this bucket will expire if no new flows are added*/
	time_t forceExpireTime; /**<timestamp when this bucket is forced to expire */
