...
class IpfixDbReader : public Module, public Source<IpfixRecord*>, public Destination<NullEmitable*> 
{
	...
	protected:
		...
		int dbReaderSendNewTemplate(boost::shared_ptr<IpfixRecord::DataTemplateInfo> templateInfo, const string& tableName);
		int dbReaderSendTable(boost::shared_ptr<IpfixRecord::DataTemplateInfo> templateInfo, const string& tableName);
		int dbReaderDestroyTemplate(boost::shared_ptr<IpfixRecord::DataTemplateInfo> templateInfo);
